      ...
      <div className="w-9/12 flex justify-end items-center">
        ...
        <div className="hidden md:flex">
          <a
            ...
            target="_blank"
          >
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">LIQUIDITY</ul>
          </a>
          <a href="/swap" target="_blank">
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">SWAP</ul>
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=100089909078977"
            target="_blank"
          >
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">LENDING</ul>
          </a>
          <a href="/swap" target="_blank">
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">STAKE</ul>
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=100089909078977"
            target="_blank"
          >
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">LOCKER</ul>
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=100089909078977"
            target="_blank"
          >
            <ul className="ulnav mx-4 md:text-sm lg:text-lg">OATPAPER</ul>
          </a>
        </div>
      </div>
    </nav>
